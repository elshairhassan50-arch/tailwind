...
function AiTypes() {
  return (
    <section id='types' className='app-container py-12'>
      <div className='text-center mb-12'>
        ...
        <p className='section-description'>
          Explore the different categories of AI and how they are transforming various industries.
        </p>
      </div>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
        {aiTypes.map((type) => (
          <article key={type} className='ai-type-card'>
            <img
             src={type.image}
              alt={type.title}
