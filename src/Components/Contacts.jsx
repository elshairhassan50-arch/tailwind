  ...
  return (
    <section id='contact' className='app-container py-16'>
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
        ...
        {/* Contact info */}
        <div>
          <span className='section-subheader block mb-2'>Get In Touch</span>
          ...
          <div className='mt-8 space-y-4'>
            {contactDetails.map((detail, i) => (
              ...
              key={i}>
                ...
                <div >
                  <div className='contact-title'>{detail.title}</div>
                <div className='contact-text'>{detail.text}</div></div>
          ...
          <div className='bg-white  rounded-xl shadow-lg p-6 lg:p-8'> 
            <form >
              <div className='space-y-6'>
                ...
                <textarea className='form-input' placeholder='Your Message' rows='4' />
                </div>                
              </div>
